In this case study, Big Data Analysts were tasked to evaluate the business performance of Kimia Farma from years 2020-2023, utilizing data from the following datasets:
